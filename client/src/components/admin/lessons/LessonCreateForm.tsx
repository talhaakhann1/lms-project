...
import { createLessonSchema } from "@/src/Schemas/lession.scehma";
...
export function LessonCreateForm({ courseId, instructors }: LessonFormProps) {
  ...
  async function onSubmit(data: LessonFormValues) {
    try {
    await lessonService.create(courseId as string, data)
      ...
      showError("Error in creating leson", errorMessage);
    }
  }
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} noValidate>
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-muted-foreground">
              Fill in the details below to publish a new lesson.
            </CardDescription>
          </CardHeader>
            ...
            <Controller
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Textarea
                    id="description"
                    placeholder="Short summary about this lesson?"
