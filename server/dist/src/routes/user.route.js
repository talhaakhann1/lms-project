...
import { loginUser, logoutUser, refreshAccessToken, registerUser, changeUserAvatar, getCurrentUser, getUsers, assignRole, getAllInstructors, updateUserProfile, } from "../controllers/user.controller.js";
...
router
    ...
    .patch(verifyJWT, upload.single("avatar"), validate(updateUserProfileSchema), updateUserProfile);
