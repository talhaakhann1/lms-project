...
export const createLesson = asyncHandler(async (req, res) => {
    ...
    return res
        .status(201)
        .json(new ApiResponse(201, createdLesson, "Successfully created the lession"));
});
export const updateLesson = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, updatedLesson, "Successfully updated the lesson"));
});
export const deleteLesson = asyncHandler(async (req, res) => {
    ...
    const deleteVideo = await deleteAtCloudinary(lesson?.video.publicId, "video");
...
export const updateLessonVideo = asyncHandler(async (req, res) => {
    const { lessonId } = req.params;
    if (!lessonId) {
    ...
    if (!updatedVideo) {
        throw new ApiError(400, "Something went wrong while updating lesson video");
    }
    const deleteVideo = await deleteAtCloudinary(updatedVideo.video?.publicId, "video");
    if (!deleteVideo) {
        throw new ApiError(500, "Somethng went wrong while deleting at cloudinary");
    }
    return res
